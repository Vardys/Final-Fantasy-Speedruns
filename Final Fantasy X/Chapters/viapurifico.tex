...
\begin{spheregrid}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Level 2 Keysphere
			\item Move $\uparrow\uparrow\uparrow\leftarrow$
			\item Mag+3
		\end{itemize}
		...
		\yunaf
		\begin{itemize}
			\item \teleportsphere{} to Auron's Magic Node $\uparrow$
			\item Mag+3, Str+4
			...
			\item Str+2
		\end{itemize}
		\ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.8\columnwidth]{graphics/Yuna_Via_Purifico}}{\includegraphics[width=.45\columnwidth]{graphics/Yuna_Via_Purifico}}
	\end{itemize}
\end{spheregrid}
\begin{enumerate}[resume]
	\item Check how many \powersphere{} you have left, you need 15 more for the rest of the run
...
\begin{battle}{Evrae Altana}
	\begin{itemize}
		...
		\item Anyone: \phoenixdown x2/\elixir{} Evrae Altana
	\end{itemize}
\end{battle}
\begin{enumerate}[resume]
