...
\begin{spheregrid}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item +200 HP
		\end{itemize}
		\ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.8\columnwidth]{graphics/kimahrimmr}}{\includegraphics[width=.4\columnwidth]{graphics/kimahrimmr}}
		\wakkaf (7 S.Lvl)
		\begin{itemize}
	...
	\begin{itemize}
		\item Sell
		      \begin{itemize}
			      ...
			      \item \elixir{}
			      \item \huntersspear{}
			      \item Anything other than \longsword{}, \officialball{}, \lightningsteel{}, \thunderball{}
		      \end{itemize}
		\item Buy
		      \begin{itemize}
			      \item \sentry{}, Equip
...
\begin{battle}[12000]{Sinspawn Gui 1}
	\begin{itemize}
		\switch{\yuna}{\auron}
		\auronf \powerbreak{} Main Body
		\tidusf Defend
		\wakkaf Switch Weapon to \thunderball{}, \powerball{}, or \officialball{}
		\switch{\wakka}{\kimahri}
		\kimahrif \selfdestruct main body
		\switch{\tidus}{\yuna}
		\summon{\valefor}
...
\end{battle}
\begin{enumerate}[resume]
	\item \skippablefmv (press Start immediately after the skip. Do not use it on the upcoming scenes, as you will crash your game). Walk left and up to Gatta, \sd. \fmv+\cs[1:30], \sd\ during \tidus\ monologue. \cs[1:00], \sd
