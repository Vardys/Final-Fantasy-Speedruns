		      ...
		      \begin{itemize}
			      \item \textit{First Wave}
			            \begin{itemize}
				            \tidusf Attack
				            \kimahrif Attack
				            \luluf \thunder a different Machina
				            \tidusf Attack
				            \kimahrif \od\ \seedcannon \textit{if no crits else} Attack
			            \end{itemize}
			      ...
			      \item \textit{Third Wave}
			            \begin{itemize}
				            \tidusf Attack
				            \kimahrif Attack or \od\ \seedcannon
				            \luluf \thunder a different Machina
			            \end{itemize}
		      \end{itemize}
	\end{itemize}
...
\begin{enumerate}[resume]
	\item If anyone is under 250 HP, use \potion{}.
...
\begin{battle}[3000]{Oblitzerator}
	\begin{itemize}
		...
		\luluf \thunder Crane x3
		\tidusf Use Crane after \lulu's string
		\kimahrif Defend
		\luluf \thunder
		\tidusf Attack
	\end{itemize}
	Check for \textbf{\lightningsteel{}, \thunderball}
\end{battle}
\begin{enumerate}[resume]
...
\begin{spheregrid}
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	\ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.6\columnwidth]{graphics/haste}}{\includegraphics[width=.3\columnwidth]{graphics/haste}}
\end{spheregrid}
\begin{enumerate}[resume]
...
\begin{equip}
	\begin{itemize}
		\item \textit{If you got \lightningsteel{}}
		      \begin{itemize}
			      \tidusf \lightningsteel{}
		      \end{itemize}
		\item \textit{If you got \thunderball}
		      \begin{itemize}
			      \wakkaf \thunderball
		      \end{itemize}
	\end{itemize}
	...
	\begin{itemize}
		\item{If \lightningsteel{}:}
		      \begin{itemize}
			      ...
			      \tidusf Attack
		      \end{itemize}
		\item{If Thunderball and no \lightningsteel{}:}
		      \begin{itemize}
			      \tidusf Cheer
			      \wakkaf Attack
