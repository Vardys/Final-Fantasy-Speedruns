	...
	\blitzballdetermination[true]{}{%
		      ...
		      \item Do the following Dual Horn encounter
		            \begin{battle}{Dual Horns}
			            \begin{itemize}
				            \tidusf Haste \tidus\ \textit{If no \petrifygrenade else } Defend
				            \tidusf Attack Dual Horns
				            \rikkuf 1 \petrifygrenade{}/\smokebomb{}/\silencegrenade{} (Try to keep Sleeping Powders)
				            \tidusf Attack
			            \end{itemize}
		            \end{battle}
		      	\item Open the rear chest for a \textbf{\friendsphere}, with the codes: Bottom Middle (up x2), Middle Right (up x4), Middle (down x4) %wtf does this line mean
	}
