\chapter{Baaj Temple}\label{ch:baaj-temple}
...
\begin{enumerate}[resume]
	\item Heal \tidus \ with \potion. Open options, switch cursor to memory, aeons to short (last in menu; forth and sixth item).
