...
\begin{enumerate}[resume]
	...
	\item Make sure that \rikku's \od\ is charged. Can skip if using \skillsphere for Armor Break.
	...
	\begin{multicols}{2}
		\begin{itemize}
			\item \textit{If you got 2 or 4 \textbf{Return Spheres}:}
			      \begin{itemize}
				      \yunaf \attributesphere \rikku's +3 Agi (hold L $\nwarrow$ close to \rikku's Position)
				      \item \returnsphere ($\downarrow \downarrow \leftarrow \leftarrow$) or \friendsphere ($\downarrow \leftarrow$) there
				      \item Go down, picking up Agi+4, \sparechange, Agi+4
			      \end{itemize}
			...
			\item \textit{If you got 0 \textbf{Return Spheres}:}
			      \begin{itemize}
				      ...
				      \item Move $\swarrow$
				      \item Agi+4
				      \item \attributesphere Agi+3 at the start of \rikku\'s grid
			      ...
			      \end{itemize}
				            \rikkuf If no \od, use \skillsphere to learn \armorbreak
		\end{itemize}
	\end{multicols}
\end{spheregrid}
\colstart
	...
	\begin{battle}[180000]{Braska's Final Aeon}
		\begin{itemize}
			\switch{\yuna}{\rikku}
			\rikkuf \od\ Mix \grenade + \hpsphere or \armorbreak
			\tidusf Talk
			\switch{\auron}{\yuna}
			\summon{\bahamut}
			\bahamutf Attack
...
\begin{battle}[99999]{Yu Yevon}
	\begin{itemize}
		...
		\item Anyone Else Zombie Strike Weapon:
		      ...
		      \item Anyone: \phoenixdown Yu Yevon
	\end{itemize}
\end{battle}
\bothvfill
\colstart