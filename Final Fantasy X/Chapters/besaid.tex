...
\begin{spheregrid}
	\begin{itemize}
		\item \textit{If Tidus has 3 levels:}
		      ...
		      \end{itemize}
		      \ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.7\columnwidth]{graphics/tiduscheer}}{\includegraphics[width=.4\columnwidth]{graphics/tiduscheer}}
	\end{itemize}
\end{spheregrid}
...
\begin{battle}{Garuda}
	\begin{itemize}
		\summon{\valefor}
		\valeforf \thunder x6 to build \od
	\end{itemize}
\end{battle}
\begin{enumerate}[resume]
