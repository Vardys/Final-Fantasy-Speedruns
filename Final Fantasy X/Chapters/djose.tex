...
\begin{spheregrid}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Str +2
		\end{itemize}
		\ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.6\columnwidth]{graphics/djosewakka}}{\includegraphics[width=.35\columnwidth]{graphics/djosewakka}}
	\end{itemize}
\end{spheregrid}
\begin{enumerate}
	...
	\begin{itemize}
		\item Basilisk:
		      \begin{itemize}
			      ...
			      \kimahrif Lancet Basilisk, learn \textbf{\stonebreath}
			      \item \flee.
		      \end{itemize}
		\item Else \flee
	\end{itemize}
